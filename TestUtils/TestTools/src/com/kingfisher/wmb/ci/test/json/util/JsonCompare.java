package com.kingfisher.wmb.ci.test.json.util;
...
public class JsonCompare 
{
	...
	{
		//log.info("Expected:"+controlMessage);
		//log.info("Actual: "+testMessage);
...
/*		HashMap<Object, Object> controlMessageObjClone = (HashMap<Object, Object>)controlMessageObj.clone();
		...
		//return 	controlMessageObj==testMessageObj;		
	}
	...
	public static void main(String args[]) throws IOException
	{
		...
		String testMessage="{    \"Class\": [\"Aisle\"],    \"properties\":    {       \"storageLocation\": 115E+0,       \"aisleNumber\": \"A709\",       \"storageType\": \"IM\",       \"description\": \"Selling Space Aisle\"    },    \"entities\": [   {       \"Class\": [\"FulfilmentSite\"],       \"rel\": [\"urn:x-kingfisher:name:parentStore\"],       \"properties\": {\"siteNumber\": \"1115\"},       \"links\": [      {          \"rel\": [\"self\"],          \"href\": \"http://unxs0384.ghanp.kfplc.com:8070/FulfilmentSite/1115\"       }]    }] }";
